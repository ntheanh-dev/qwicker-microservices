...
public class InternalPostController {
    ...
    ApiResponse<?> shipperJoinPost(@PathVariable(name = "post-id") String postId, @PathVariable(name = "shipper-id") String shipperId) {
        postService.shipperJoinPost(postId, shipperId);
        return ApiResponse.builder().build();
    }

    @GetMapping("/{post-id}/is-shipper-join/{shipper-id}")
    ApiResponse<Boolean> isShipperJoinPost(@PathVariable(name = "post-id") String postId, @PathVariable(name = "shipper-id") String shipperId) {
        postService.shipperJoinPost(postId, shipperId);
    ...
    ApiResponse<Integer> countShipperJoinedByPostId(@PathVariable(name = "id") String postId) {
        return ApiResponse.<Integer>builder().result(postService.countShipperJoinByPostId(postId)).build();
    }
    ...
    ApiResponse<List<String>> findAllJoinedShipperIdsByPostId(@PathVariable(name = "id") String postId) {
        return ApiResponse.<List<String>>builder().result(postService.findAllJoinedShipperIdsByPostId(postId)).build();
    }

...
public enum PostHistoryStatus {
    ...
    PostHistoryStatus(String code, String description) {
        this.code = code;
    ...
    public static PostHistoryStatus fromCode(String code) {
        for (PostHistoryStatus status : PostHistoryStatus.values()) {

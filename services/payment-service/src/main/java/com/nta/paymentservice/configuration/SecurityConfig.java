...
public class SecurityConfig {
    ...
    private static final String[] PUBLIC_GET_ENDPOINTS = {"/payments/vn-pay-callback"};
    private static final String[] PUBLIC_POST_ENDPOINTS = {"/internal/payments/find-by-posts"};
